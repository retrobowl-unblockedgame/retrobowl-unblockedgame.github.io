  ...
  if (results.length > 0) {
    results.forEach((item) => {
      if (item) {
        ...
        if (totalRevs > 0) {
            rating = ((item["upvote"] / totalRevs) * 5).toFixed(1);
        }
        ...
        li.innerHTML = `<img src="${
          ...
          item.name
        }"class="search-result-thumb"><div class="search-result-info"><text style='color: #ffd700; font-size: smaller;'><i class="fas fa-star"></i>${rating}</text> ${
